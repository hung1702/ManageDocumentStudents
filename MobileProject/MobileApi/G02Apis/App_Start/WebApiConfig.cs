...
namespace G02Apis
{
    public static class WebApiConfig
    {
        public static void Register(HttpConfiguration config)
        {
            ...
            //builder.EntitySet<DiaChi>("DiaChi");
            //builder.EntitySet<GiangVien>("GiangVien");
            builder.EntitySet<SinhVien>("SinhVien");
            builder.EntitySet<LopSinhVien>("LopSinhVien");
            builder.EntitySet<Khoa>("Khoa");


            builder.EntitySet<Diem>("Diem");
            builder.EntitySet<HocKy>("HocKy");
            builder.EntitySet<HocPhi>("HocPhi");
            builder.EntitySet<LoaiVB>("LoaiVB");
            builder.EntitySet<MonHoc>("MonHoc");
            builder.EntitySet<VanBan>("VanBan");
            //builder.EntitySet<Truong>("Truong");
