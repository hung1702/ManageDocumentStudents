...
{
    public class DuKienDiemPopupViewModel : ViewModelBase
    {
        ...
        public DuKienDiemPopupViewModel(INavigationService navigationService, IUserService iUserService) : base(navigationService)
        {
